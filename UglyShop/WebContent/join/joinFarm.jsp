				...
				<div class="bg-light p-5 mt-2">
					<form action="<%=request.getContextPath()%>/joinFarmer"
						...
						<div class="form-group mt-3">
			              <button type="submit" class="btn btn-dark" style= "width:100%;">농민 가입하기</button>
			              <a class="btn btn-primary me-2 mt-3" style= "width:100%;" href="joinUser.jsp" role="button"> 고객 회원가입</a>
			            </div>
